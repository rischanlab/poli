 ...
 * You are free to use, modify
 and distribute this software, but all copyright information must remain.
 *
...
{	
	...
	public function get_field_types()
	{
		...
		$types	= array();
		//die(print_r($this->basic_model->get_field_types_basic_table()));
	    //die(print_r($this->relation));
...
class grocery_CRUD_Model_Driver extends grocery_CRUD_Field_Types
{
	...
	{
		//die(print_r(' FieldName:'. $field_name .'Related Field: '.$related_field_title.' where clause: '.$where_clause));
